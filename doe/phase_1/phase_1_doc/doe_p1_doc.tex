...
This Phase 1 submission addresses the U.S. DOE challenge of resilient, cost-effective deployment of energy storage and microgrids under real grid constraints. The core difficulty is combinatorial: selecting locations, capacities, and operating designs across many scenarios while still honoring AC feasibility and reliability standards. We propose a hybrid workflow where quantum optimization accelerates the discrete planning search and classical solvers enforce physical validity. The framework is explicitly aligned to three DOE-relevant outcomes: improved reliability/resilience, reduced lifecycle investment burden, and better operational voltage performance. The output is a ranked set of deployment portfolios with traceable trade-offs and utility-ready feasibility checks.
