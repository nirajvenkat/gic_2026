...
The prototype will be validated against classical baselines on the same reduced instances, with the goal of showing better candidate quality and faster iteration on the same planning problems\footnote{Primary reference for this challenge: Nature Machine Intelligence article, \"https://www.nature.com/articles/s43588-025-00873-y\".}.
