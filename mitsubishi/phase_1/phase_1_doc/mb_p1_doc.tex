...
\begin{itemize}[leftmargin=*, itemsep=0pt, topsep=0pt, parsep=0pt, partopsep=0pt]
  \item \underline{Ground-State Preparation:} Deploy a lightweight, purpose-built GQE that optimizes for circuit gate efficiency to generate state-preparation circuits for the IMePh ground state. The resulting circuits are then validated against the exact classical ground-state reference from Full Configuration Interaction (FCI).
